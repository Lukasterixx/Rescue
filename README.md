...
One sim: the Go2 with its D1 arm and wrist RealSense, in the RoboCup Rescue competition's lanes and D1Training's cup demo. [`Isaac/go2_omniverse/rescue_sim/README.md`](Isaac/go2_omniverse/rescue_sim/README.md) has everything: the levels, the arm, the camera, every ROS topic, and what has and has not been checked.
